    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.current?.show({
                ...
                detail:   err.message ?? 'Credenciales incorrectas. Inténtalo de nuevo.',
                life:     4000,
            });
        } finally {
            setCargando(false);
        ...
        <div className="min-h-screen flex"
            ...
            <div className="hidden lg:flex flex-column align-items-center justify-content-center"
                ...
                <img src="/emisora.png" alt="Emisora Comunal del Cesar"
                    style={{ width: 220, objectFit: 'contain', marginBottom: '2rem' }} />
                ...
                <div className="surface-card border-round-2xl shadow-4 p-5 lg:p-7 w-full" style={{ maxWidth: 460 }}>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-column gap-4" noValidate>
                        ...
                        <div className="flex align-items-center justify-content-between">
                            ...
                            <Link to="/reset-password" className="text-sm font-medium no-underline"
                                style={{ color: VERDE }}>
